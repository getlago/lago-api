...
ALTER TABLE IF EXISTS ONLY public.usage_monitoring_alerts DROP CONSTRAINT IF EXISTS fk_rails_1746191cff;
...
DROP INDEX IF EXISTS public.index_usage_monitoring_alerts_on_charge_id;
...
DROP INDEX IF EXISTS public.idx_alerts_unique_per_type_per_customer_with_charge;
DROP INDEX IF EXISTS public.idx_alerts_unique_per_type_per_customer;
...
--
-- Name: idx_alerts_unique_per_type_per_customer; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_alerts_unique_per_type_per_customer ON public.usage_monitoring_alerts USING btree (subscription_external_id, organization_id, alert_type) WHERE ((charge_id IS NULL) AND (deleted_at IS NULL));


--
-- Name: idx_alerts_unique_per_type_per_customer_with_charge; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_alerts_unique_per_type_per_customer_with_charge ON public.usage_monitoring_alerts USING btree (subscription_external_id, organization_id, alert_type, charge_id) WHERE ((charge_id IS NOT NULL) AND (deleted_at IS NULL));
...
--
-- Name: index_usage_monitoring_alerts_on_charge_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_usage_monitoring_alerts_on_charge_id ON public.usage_monitoring_alerts USING btree (charge_id);
...
--
-- Name: usage_monitoring_alerts fk_rails_1746191cff; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.usage_monitoring_alerts
    ADD CONSTRAINT fk_rails_1746191cff FOREIGN KEY (charge_id) REFERENCES public.charges(id);
