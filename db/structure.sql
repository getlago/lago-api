...
DROP INDEX IF EXISTS public.index_plan_product_items_on_plan_id_and_rate_card_id;
...
--
-- Name: index_plan_product_items_on_plan_id_and_rate_card_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_plan_product_items_on_plan_id_and_rate_card_id ON public.plan_product_items USING btree (plan_id, rate_card_id) WHERE (deleted_at IS NULL);
