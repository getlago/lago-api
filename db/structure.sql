...
DROP INDEX IF EXISTS public.index_product_items_on_organization_id_and_code;
...
DROP INDEX IF EXISTS public.index_billing_cycles_on_product_item_and_period;
...
CREATE INDEX idx_spi_billable ON public.subscription_rate_cards USING btree (next_billing_at) WHERE ((deleted_at IS NULL) AND (ended_at IS NULL));
...
--
-- Name: index_billing_cycles_on_product_item_and_period; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_billing_cycles_on_product_item_and_period ON public.billing_cycles USING btree (subscription_rate_card_id, period_from);
...
--
-- Name: index_product_items_on_organization_id_and_code; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_product_items_on_organization_id_and_code ON public.product_items USING btree (organization_id, code) WHERE (deleted_at IS NULL);
...
CREATE UNIQUE INDEX index_rate_phases_on_sub_product_item_id_and_position ON public.rate_phases USING btree (subscription_rate_card_id, "position") WHERE ((subscription_rate_card_id IS NOT NULL) AND (deleted_at IS NULL));
