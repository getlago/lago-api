...
CREATE VIEW public.flat_filters AS
 SELECT billable_metrics.organization_id,
    ...
    jsonb_object_agg(billable_metric_filters.key,
        CASE
  ...
  GROUP BY billable_metrics.organization_id, billable_metrics.code, charges.plan_id, charges.updated_at, charges.id, charge_filters.id, charge_filters.updated_at;
