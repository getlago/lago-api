...
ActiveRecord::Schema[7.1].define(version: 2025_01_10_095908) do
  ...
  create_table "invoices", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["issuer_type", "issuer_id"], name: "index_invoices_on_issuer"
    ...
    t.index ["recipient_type", "recipient_id"], name: "index_invoices_on_recipient"
