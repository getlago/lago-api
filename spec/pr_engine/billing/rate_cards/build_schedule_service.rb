...
# Vendored verbatim from app/services/billing/rate_cards/build_schedule_service.rb on PR getlago/lago-api#6267
...
module PrEngine::Billing
  module RateCards
    class BuildScheduleService < BaseService
      ...
      def rate_phases
        PrEngine::SubscriptionRateCards::ResolveRatePhasesService.call!(
