...
# Vendored verbatim from app/services/billing/segments.rb on PR getlago/lago-api#6267 (branch `engine-dates`).
# Do not edit: this is the frozen PR engine. Only the namespace and the internal constant
# references are re-rooted under `PrEngine::`; every method body is the PR's own.
module PrEngine; end
