    ...
    it "returns the expected customer usage" do
      ...
      travel_to(DateTime.new(2023, 3, 6)) do
        ...
        expect(json[:customer_usage][:charges_usage][0][:grouped_usage]).to match_array(
          [
            {amount_cents: 902, events_count: 1, units: "10.0", grouped_by: {group_key: "value 2"}, filters: [], projected_amount_cents: 13979, projected_units: "155.0", pricing_unit_details: nil},
            {amount_cents: 10, events_count: 1, units: "10.0", grouped_by: {group_key: "value 1"}, filters: [], projected_amount_cents: 157, projected_units: "155.0", pricing_unit_details: nil}
          ]
        )
      end
    end
