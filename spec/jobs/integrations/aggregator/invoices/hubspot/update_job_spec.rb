...
RSpec.describe Integrations::Aggregator::Invoices::Hubspot::UpdateJob, type: :job do
  ...
  before do
    allow(Integrations::Aggregator::Invoices::Hubspot::UpdateService).to receive(:new).and_return(service)
  ...
  it "calls the aggregator create invoice hubspot service" do
    ...
    aggregate_failures do
      expect(Integrations::Aggregator::Invoices::Hubspot::UpdateService).to have_received(:new)
