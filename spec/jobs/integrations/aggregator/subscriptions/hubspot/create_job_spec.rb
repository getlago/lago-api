...
RSpec.describe Integrations::Aggregator::Subscriptions::Hubspot::CreateJob, type: :job do
  ...
  before do
    allow(Integrations::Aggregator::Subscriptions::Hubspot::CreateService).to receive(:new).and_return(service)
  ...
  context 'when the service call is successful' do
    it 'calls the aggregator create subscription crm service' do
      ...
      aggregate_failures do
        expect(Integrations::Aggregator::Subscriptions::Hubspot::CreateService).to have_received(:new)
