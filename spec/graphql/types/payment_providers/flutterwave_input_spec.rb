...
RSpec.describe Types::PaymentProviders::FlutterwaveInput do
  ...
  it do
    ...
    expect(subject).to accept_argument(:encryption_key).of_type("String!")
    expect(subject).to accept_argument(:name).of_type("String!")
    expect(subject).to accept_argument(:production).of_type("Boolean")
    ...
    expect(subject).to accept_argument(:webhook_secret).of_type("String")
  end
end
