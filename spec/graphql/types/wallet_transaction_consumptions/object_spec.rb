...
RSpec.describe Types::WalletTransactionConsumptions::Object do
  ...
  it "has the expected fields with correct types" do
    ...
    expect(subject).to have_field(:inbound_wallet_transaction).of_type("WalletTransaction!")
    expect(subject).to have_field(:outbound_wallet_transaction).of_type("WalletTransaction!")
  end
