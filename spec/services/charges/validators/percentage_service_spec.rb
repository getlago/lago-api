...
RSpec.describe Charges::Validators::PercentageService, type: :service do
  ...
  describe ".valid?" do
    ...
    context "with per_transaction_min_amount", :lago_premium do
    ...
    context "with per_transaction_max_amount", :lago_premium do
    ...
    context "with both per_transaction_min_amount and per_transaction_max_amount", :lago_premium do
