...
RSpec.describe BillingService, type: :service do
  ...
  describe '.call' do
    context 'when billed monthly on subscription date' do
      let(:plan) { create(:plan, frequency: :monthly, billing_period: :subscription_date) }
    ...
    context 'when billed yearly on subscription date' do
      let(:plan) { create(:plan, frequency: :yearly, billing_period: :subscription_date) }
    ...
    context 'when billed monthly on beginning of period' do
      let(:plan) { create(:plan, frequency: :monthly, billing_period: :beginning_of_period) }
    ...
    context 'when billed yearly on beginning of period' do
      let(:plan) { create(:plan, frequency: :yearly, billing_period: :beginning_of_period) }
