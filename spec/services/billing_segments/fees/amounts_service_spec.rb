...
RSpec.describe BillingSegments::Fees::AmountsService do
  describe ".call" do
    subject(:result) do
    ...
    context "without a pricing unit on the billing segment" do
    ...
    context "with a pricing unit on the billing segment" do
