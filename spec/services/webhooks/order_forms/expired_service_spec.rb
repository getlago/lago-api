...
RSpec.describe Webhooks::OrderForms::ExpiredService do
  ...
  let(:order_form) { create(:order_form, :expired, organization:, customer:) }

  describe ".call", :premium do
    it_behaves_like "creates webhook", "order_form.expired", "order_form", {
      "lago_id" => String,
      "number" => String,
      "status" => "expired",
      "void_reason" => "expired",
