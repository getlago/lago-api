...
RSpec.describe Webhooks::Quotes::CreatedService do
  ...
  before { create(:quote_version, organization:, quote:, content: "<p>Terms</p>") }
  ...
  describe ".call", :premium do
    ...
    it "omits the heavy and internal attributes" do
      ...
      expect(payload["quote"]["current_version"]).not_to have_key("content")
      expect(payload["quote"]["current_version"]).not_to have_key("billing_items")
    end
  end
