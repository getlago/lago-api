...
RSpec.describe Integrations::Aggregator::Invoices::Hubspot::UpdateService do
  ...
  describe "#call_async" do
    ...
    context "when invoice exists" do
      ...
      it "enqueues invoice update job" do
        expect { service_call_async }.to enqueue_job(Integrations::Aggregator::Invoices::Hubspot::UpdateJob)
      end
    end
