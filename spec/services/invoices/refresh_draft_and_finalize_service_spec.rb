  ...
  describe "#call" do
    ...
    context "when tax integration is set up" do
      ...
      before do
        ...
        allow(Invoices::GenerateFilesAndNotifyJob).to receive(:perform_later).and_call_original
      ...
      context "when taxes are unknown" do
        ...
        it "does not send any updates" do
          ...
          aggregate_failures do
            ...
            expect(Invoices::GenerateFilesAndNotifyJob).not_to have_received(:perform_later)
