...
RSpec.describe DataExports::Csv::InvoiceFees do
  ...
  describe '#call' do
    ...
    it 'generates the correct CSV output' do
      expected_csv = <<~CSV
        invoice_lago_id,invoice_number,invoice_issuing_date,fee_lago_id,fee_item_type,fee_item_code,fee_item_name,fee_item_invoice_display_name,fee_item_filter_invoice_display_name,fee_item_grouped_by,subscription_external_id,subscription_plan_code,fee_from_date,fee_to_date,fee_amount_currency,fee_units,fee_precise_unit_amount,fee_precise_coupons_amount_cents,fee_taxes_amount_cents,fee_total_amount_cents
