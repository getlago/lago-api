...
RSpec.describe "receipes:events:delete" do # rubocop:disable RSpec/DescribeClass
  let(:task) { Rake::Task["receipes:events:delete"] }
  ...
  before do
    Rake.application.rake_require("tasks/receipes")
