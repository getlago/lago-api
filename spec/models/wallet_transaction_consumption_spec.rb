...
RSpec.describe WalletTransactionConsumption do
  describe "associations" do
    it do
      ...
      is_expected.to belong_to(:inbound_wallet_transaction).class_name("WalletTransaction")
      is_expected.to belong_to(:outbound_wallet_transaction).class_name("WalletTransaction")
    end
  end

  describe "validations" do
    it { is_expected.to validate_numericality_of(:amount_cents_consumed).is_greater_than(0) }
