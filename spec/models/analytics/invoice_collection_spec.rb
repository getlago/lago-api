...
RSpec.describe Analytics::InvoiceCollection, type: :model do
  ...
  describe ".find_all_by" do
    ...
    let(:invoices) { [
      ...
      create(:invoice, organization:, billing_entity: billing_entity2, issuing_date: 1.months.ago, total_amount_cents: 300, status: :pending),
      create(:invoice, organization:, billing_entity: billing_entity2, issuing_date: 1.months.ago, total_amount_cents: 400, status: :finalized),
    ] }
