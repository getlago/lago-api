...
RSpec.describe ProductItem do
  ...
  describe "#attached_to_plan_or_subscription?" do
    ...
    it "is true when a plan product item references it" do
      rate_card = create(:rate_card, organization: product_item.organization, product_item:)
      create(:plan_rate_card, organization: product_item.organization, rate_card:)
    ...
    it "is true when a subscription product item references it" do
      rate_card = create(:rate_card, organization: product_item.organization, product_item:)
      create(:subscription_rate_card, organization: product_item.organization, rate_card:)
