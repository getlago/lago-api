...
RSpec.describe Credit do
  ...
  describe "scopes" do
    ...
    let(:deleted_invoice) { create(:invoice, status: :deleted) }
    ...
    before do
      ...
      create(:credit, invoice: deleted_invoice)
    end

    describe ".active" do
      it "returns only credits with non-voided, non-closed and non-deleted invoices" do
