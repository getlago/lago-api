...
# Vendored verbatim from app/services/billing_periods/first_period_service.rb
...
module LegacyEngine::BillingPeriods
  ...
  class FirstPeriodService < BaseService
    ...
    def self.from_subscription_rate_card(subscription_rate_card, rate:)
      call(
        ...
        started_at: subscription_rate_card.started_at
      )
    end
