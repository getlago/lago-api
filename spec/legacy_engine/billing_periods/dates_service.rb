...
# Vendored verbatim from app/services/billing_periods/dates_service.rb
...
module LegacyEngine::BillingPeriods
  ...
  class DatesService < BaseService
    ...
    def self.from_subscription_rate_card(
      ...
      rates:,
      range:, rate_phases: LegacyEngine::SubscriptionRateCards::ResolveRatePhasesService::RatePhases.new(phases: []),
