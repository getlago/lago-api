...
# Vendored verbatim from app/services/billing_periods/dates/base_service.rb
  ...
  module Dates
    class BaseService < ::BaseService
      ...
      def initialize(
        ...
        options: LegacyEngine::BillingPeriods::DatesService::Options.default,
      ...
      def cycle_at(cycle_start, cycle_index, interval:, anchor_date:)
        ...
        LegacyEngine::BillingPeriods::DatesService::Cycle.new(
          index: cycle_index,
          period_from:,
          period_to:,
      ...
      def periods_for_cycle(cycle)
        ...
        segment_starts.each_with_index.filter_map do |start_at, index|
          ...
          period = LegacyEngine::BillingPeriods::DatesService::Period.new(
