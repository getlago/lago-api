...
RSpec.describe Api::V2::ProductItems::FiltersController do
  ...
  describe "POST /api/v2/product_items/:product_item_id/filters" do
    subject { post_with_token(organization, "/api/v2/product_items/#{product_item.code}/filters", {filter: create_params}) }
  ...
  describe "PUT /api/v2/product_items/:product_item_id/filters/:id" do
    subject do
      put_with_token(
        organization,
        "/api/v2/product_items/#{product_item.code}/filters/#{filter.code}",
    ...
    context "when the filter does not exist" do
      subject { put_with_token(organization, "/api/v2/product_items/#{product_item.code}/filters/#{SecureRandom.uuid}", {filter: update_params}) }
  ...
  describe "GET /api/v2/product_items/:product_item_id/filters/:id" do
    subject { get_with_token(organization, "/api/v2/product_items/#{product_item.code}/filters/#{filter.code}") }
  ...
  describe "GET /api/v2/product_items/:product_item_id/filters" do
    subject { get_with_token(organization, "/api/v2/product_items/#{product_item.code}/filters") }
    ...
    context "with a search term" do
      subject { get_with_token(organization, "/api/v2/product_items/#{product_item.code}/filters?search_term=findme") }
  ...
  describe "DELETE /api/v2/product_items/:product_item_id/filters/:id" do
    subject { delete_with_token(organization, "/api/v2/product_items/#{product_item.code}/filters/#{filter.code}") }
