...
RSpec.describe Api::V1::Products::FiltersController do
  ...
  describe "POST /api/v1/products/:product_id/filters" do
    subject { post_with_token(organization, "/api/v1/products/#{product.code}/filters", {filter: create_params}) }
    ...
    context "when the product does not exist" do
      subject { post_with_token(organization, "/api/v1/products/#{SecureRandom.uuid}/filters", {filter: create_params}) }
  ...
  describe "PUT /api/v1/products/:product_id/filters/:id" do
    subject do
      put_with_token(
        organization,
        "/api/v1/products/#{product.code}/filters/#{filter.code}",
    ...
    context "when the filter does not exist" do
      subject { put_with_token(organization, "/api/v1/products/#{product.code}/filters/#{SecureRandom.uuid}", {filter: update_params}) }
  ...
  describe "GET /api/v1/products/:product_id/filters/:id" do
    subject { get_with_token(organization, "/api/v1/products/#{product.code}/filters/#{filter.code}") }
  ...
  describe "GET /api/v1/products/:product_id/filters" do
    subject { get_with_token(organization, "/api/v1/products/#{product.code}/filters") }
    ...
    context "with a search term" do
      subject { get_with_token(organization, "/api/v1/products/#{product.code}/filters?search_term=findme") }
  ...
  describe "DELETE /api/v1/products/:product_id/filters/:id" do
    subject { delete_with_token(organization, "/api/v1/products/#{product.code}/filters/#{filter.code}") }
