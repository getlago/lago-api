...
RSpec.describe Api::V1::PaymentReceiptsController, type: :request do
  ...
  describe "GET /api/v1/payment_receipts" do
    ...
    it "returns organization's payments", :aggregate_failures do
      ...
      first_payment_receipt = create(:payment_receipt, payment: first_payment)
      second_payment_receipt = create(:payment_receipt, payment: second_payment)
      third_payment_receipt = create(:payment_receipt, payment: third_payment)
    ...
    context "with invoice" do
      ...
      let(:first_payment_receipt) { create(:payment_receipt, payment: first_payment) }
