...
RSpec.describe Api::V1::WalletsController, type: :request do
  ...
  describe "POST /api/v1/wallets" do
    ...
    it "creates a wallet" do
      allow(WalletTransactions::Create::FromParamsService).to receive(:call!).and_call_original
      ...
      expect(WalletTransactions::Create::FromParamsService).to have_received(:call!).with(
