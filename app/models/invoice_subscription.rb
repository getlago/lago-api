...
#  index_uniq_invoice_subscriptions_on_all_charges_boundaries     (subscription_id,fixed_charges_from_datetime,fixed_charges_to_datetime,charges_from_datetime,charges_to_datetime) UNIQUE WHERE ((created_at >= '2023-06-09 00:00:00'::timestamp without time zone) AND (recurring IS TRUE) AND (regenerated_invoice_id IS NULL))
