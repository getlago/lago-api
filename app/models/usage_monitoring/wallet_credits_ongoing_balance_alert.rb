...
module UsageMonitoring
  class WalletCreditsOngoingBalanceAlert < Alert
    def find_value(wallet)
      wallet.credits_ongoing_balance
    end
  end
end
...
#  idx_alerts_code_unique_per_wallet                          (code,wallet_id,organization_id) UNIQUE WHERE (deleted_at IS NULL)
