...
#  idx_on_subscription_external_id_df6b76f717                      (subscription_external_id)
#  idx_on_subscription_external_id_entitlement_feature_9e6d8b4f41  (subscription_external_id,entitlement_feature_id) UNIQUE WHERE (deleted_at IS NULL)
