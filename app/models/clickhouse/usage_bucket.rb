...
module Clickhouse
  # 15-minute usage buckets per (subscription, charge, filter, grouped_by),
  # written by the RisingWave pipeline (extra/risingwave) through a ClickHouse
  # upsert sink into a ReplacingMergeTree. Always query with .final so
  # replaced row versions are collapsed.
  #
