...
module Integrations
  class NetsuiteV2Integration < BaseIntegration
    validates :client_secret, :client_id, :account_id, :script_endpoint_url, presence: true
    ...
    settings_accessors :client_id,
      ...
      :script_endpoint_url,
      :token_id
    secrets_accessors :client_secret, :token_secret
