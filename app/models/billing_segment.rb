...
# Indexes
#
#  billing_segments_no_overlapping_periods              (organization_id, subscription_id, customer_id, subscription_rate_card_id, tsrange(period_from, period_to, '[]'::text)) USING gist
...
#  index_billing_segments_on_product_and_period         (subscription_rate_card_id,period_from) UNIQUE
