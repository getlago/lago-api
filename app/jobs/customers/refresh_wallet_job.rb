...
module Customers
  class RefreshWalletJob < ApplicationJob
    ...
    def perform(customer, wallet_ids: nil, include_generating_invoices: false)
      ...
      Customers::RefreshWalletsService.call!(customer:, target_wallet_ids: wallet_ids, include_generating_invoices:)
