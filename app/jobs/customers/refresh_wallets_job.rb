...
module Customers
  class RefreshWalletsJob < ApplicationJob
    queue_as do
    ...
    retry_on(
      ...
      Rails.logger.warn(
        "RefreshWalletsJob reached max throttling retry attempts" \
    ...
    def perform(customer, wallet_ids: nil)
      Customers::RefreshWalletsService.call!(customer:, force: !wallet_ids.nil?)
    end
  end
end
