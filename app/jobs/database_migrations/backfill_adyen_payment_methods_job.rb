...
module DatabaseMigrations
  class BackfillAdyenPaymentMethodsJob < ApplicationJob
    ...
    def perform(organization_id = nil, batch_number = 1)
      unless pending_work?(organization_id)
        Rails.logger.info("Finished backfilling Adyen payment methods")
        return
      end
    ...
    def pending_work?(organization_id)
      scope = PaymentProviderCustomers::AdyenCustomer
