...
class SendWebhookJob < ApplicationJob
  ...
  WEBHOOK_SERVICES = {
    ...
    "quote_version.created" => Webhooks::QuoteVersions::CreatedService,
    "quote_version.updated" => Webhooks::QuoteVersions::UpdatedService,
    "quote_version.approved" => Webhooks::QuoteVersions::ApprovedService,
    "quote_version.voided" => Webhooks::QuoteVersions::VoidedService,
