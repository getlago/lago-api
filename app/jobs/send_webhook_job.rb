...
class SendWebhookJob < ApplicationJob
  ...
  WEBHOOK_SERVICES = {
    ...
    "charge.created" => Webhooks::Charges::CreatedService,
    "charge.updated" => Webhooks::Charges::UpdatedService,
    "charge.deleted" => Webhooks::Charges::DeletedService,
    "fixed_charge.created" => Webhooks::FixedCharges::CreatedService,
    "fixed_charge.updated" => Webhooks::FixedCharges::UpdatedService,
    "fixed_charge.deleted" => Webhooks::FixedCharges::DeletedService,
