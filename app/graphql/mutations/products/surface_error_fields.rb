...
module Mutations
  module Products
    # The billable metric and product_category are supplied by id on the GraphQL API, so a
    ...
    module SurfaceErrorFields
      ...
      FIELD_MAP = {billable_metric: :billable_metric_id, product_category: :product_category_id}.freeze
