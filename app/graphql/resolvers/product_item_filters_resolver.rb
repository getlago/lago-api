...
module Resolvers
  class ProductItemFiltersResolver < Resolvers::BaseResolver
    ...
    REQUIRED_PERMISSION = "product_item_filters:view"
    ...
    def resolve(page: nil, limit: nil, search_term: nil, product_item_id: nil, product_ids: nil, without_product: nil)
      result = ::ProductItemFiltersQuery.call(
        organization: current_organization,
        search_term:,
        pagination: {page:, limit:},
        filters: {product_item_id:, product_ids:, without_product:}
      )
