...
module Resolvers
  class SubscriptionsResolver < Resolvers::BaseResolver
    ...
    argument :overridden, Boolean, required: false
    ...
    def resolve(page: nil, limit: nil, plan_code: nil, status: nil, external_customer_id: nil, overridden: nil, search_term: nil)
      ...
      result = SubscriptionsQuery.call(
        ...
        filters: {plan_code:, status:, external_customer_id:, overridden:, exclude_next_subscriptions: true},
        search_term:
      )
