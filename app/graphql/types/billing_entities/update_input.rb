...
module Types
  module BillingEntities
    class UpdateInput < BaseInputObject
      ...
      argument :billing_configuration, Types::BillingEntities::BillingConfigurationInput, required: false, permission: "billing_entity:invoices:view"
      argument :email_settings, [Types::BillingEntities::EmailSettingsEnum], required: false, permission: "billing_entity:emails:view"
