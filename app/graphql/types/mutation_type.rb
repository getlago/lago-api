...
module Types
  class MutationType < Types::BaseObject
    ...
    field :create_plan_product_item, mutation: Mutations::PlanProductItems::Create
    ...
    field :create_product_item_filter, mutation: Mutations::ProductItemFilters::Create
