...
module Types
  class MutationType < Types::BaseObject
    ...
    field :create_pricing_import, mutation: Mutations::PricingImports::Create
    field :update_pricing_import, mutation: Mutations::PricingImports::Update
    field :confirm_pricing_import, mutation: Mutations::PricingImports::Confirm
  end
end
