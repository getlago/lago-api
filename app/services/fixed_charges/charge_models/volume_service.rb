...
# NOTE: This service is a copy of the VolumeService in the Charges namespace.
# Instead of duplicating the code, we could extract the charge models to its own scope
# and use it from both namespaces.

module FixedCharges
  module ChargeModels
    class VolumeService < FixedCharges::ChargeModels::BaseService
      protected
      ...
      def number_of_units
        @number_of_units ||= (fixed_charge.prorated? && result.full_units_number) ? result.full_units_number : units
      end
    end
  end
end
