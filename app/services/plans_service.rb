  ...
  def create(**args)
    ...
    Analytics.track(
      ...
      properties: {
        ...
        planAmountCents: plan.amount_cents,
        planPeriod: plan.pay_in_advance ? "advance" : "arrears",
        trial: plan.trial_period,
        nbCharges: args[:charges].count,
        nbStandardCharges: args[:charges].charge_model.standard.count,
        nbPercentageCharges: args[:charges].charge_model.percentage.count,
        nbGraduatedCharges: args[:charges].charge_model.graduated.count,
        nbPackageCharges: args[:charges].charge_model.package.count,
