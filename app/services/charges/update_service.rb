  ...
  class UpdateService < BaseService
    ...
    def call
      ...
      ActiveRecord::Base.transaction do
        charge.charge_model = params[:charge_model] unless plan.attached_to_live_subscriptions_or_draft_invoices?
        ...
        unless cascade
          ...
          # NOTE: charges cannot be edited if plan is attached to a live subscription or draft invoice
