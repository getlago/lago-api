...
module Plans
  class UpdatedKafkaProducerService < BaseService
    ...
    def initialize(plan:, resources_type:, resources_ids:, event_type:, billable_metric_code:, timestamp:)
      @plan = plan
    ...
    attr_reader :plan, :resources_type, :resources_ids, :event_type, :billable_metric_code, :timestamp
