  ...
  module Stores
    class BaseStore
      ...
      def for_window(filters: nil, **boundaries)
        store = self.class.new(code:, context:, boundaries:, filters: filters || self.filters, deduplicate:)
      ...
      attr_reader :code, :context, :boundaries, :grouped_by_values, :filters, :matching_filters, :ignored_filters, :deduplicate
