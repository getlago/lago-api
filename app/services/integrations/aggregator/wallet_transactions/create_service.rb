  ...
  module Aggregator
    module Invoices
      class CreateService < BaseService
        ...
        def action_path
          "v1/#{provider}/wallet_transactions"
        end

        def call
          return result unless integration
          return result unless integration.sync_wallet_transactions
          return result unless wallet_transaction.settled?
          return result if payload.integration_wallet_transaction
          ...
          IntegrationResource.create!(
            ...
            syncable_id: wallet_transaction.id,
            syncable_type: "WalletTransaction",
            resource_type: :wallet_transaction
          )

          Rails.logger.info "Integration resource created. external ID: #{result.external_id}, wallet_transaction ID: #{wallet_transaction.id}"
        ...
        def call_async
          ...
          result.wallet_transaction_id = wallet_transaction.id
          result
        end
