  ...
  module Paystack
    module Customers
      class CreateService < BaseService
        ...
        def call
          provider_customer = PaymentProviderCustomers::PaystackCustomer.find_by(customer_id: customer.id)
          provider_customer ||= PaymentProviderCustomers::PaystackCustomer.new(
        ...
        def create_customer_on_provider_service(async)
          return PaymentProviderCustomers::PaystackCreateJob.perform_later(result.provider_customer) if async
