  ...
  module Flutterwave
    module Customers
      class CreateService < BaseService
        ...
        def call
          provider_customer = PaymentProviderCustomers::FlutterwaveCustomer.find_by(customer_id: customer.id)
          provider_customer ||= PaymentProviderCustomers::FlutterwaveCustomer.new(
