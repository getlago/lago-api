...
module ProductItemFilters
  class CreateService < BaseService
    ...
    def call
      ...
      values_validation = ProductItemFilters::ValidateValuesService.call(product_item:, values_params: resolved_values.values_params)
    ...
    def resolved_values
      @resolved_values ||= ProductItemFilters::ResolveValuesService.call(product_item:, values_params: params[:values])
    end
