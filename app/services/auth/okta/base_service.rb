  ...
  module Okta
    class BaseService < BaseService
      ...
      def query_okta_access_token
        ...
        token_client = LagoHttpClient::Client.new("https://#{result.okta_integration.okta_host}/oauth2/v1/token")
        response = token_client.post_url_encoded(params, {})
        result.okta_access_token = response["access_token"]
      end

      def check_userinfo(email)
        userinfo_client = LagoHttpClient::Client.new("https://#{result.okta_integration.okta_host}/oauth2/v1/userinfo")
