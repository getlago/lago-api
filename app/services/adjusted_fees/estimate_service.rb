...
module AdjustedFees
  class EstimateService < BaseService
    ...
    def initialize_fee_for_subscription
      subscription = invoice.subscriptions.find_by(id: params[:invoice_subscription_id])
      ...
      initialize_empty_fee(subscription, nil, :subscription)
    end
