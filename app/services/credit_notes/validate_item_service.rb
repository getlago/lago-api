...
module CreditNotes
  class ValidateItemService < BaseValidator
    ...
    def valid_individual_amount?
      return true if item.amount_cents <= fee.amount_cents - credited_fee_amount_cents
    ...
    def valid_global_amount?
      return true if item.total_amount_cents <= invoice.fee_total_amount_cents - credited_invoice_amount_cents
