...
module BillingEntities
  class UpdateService < BaseService
    ...
    def handle_eu_tax_management(eu_tax_management)
      ...
      # NOTE: even if the billing_entity had eu tax management, we call this service again, it uses an upsert for taxes.
      Taxes::AutoGenerateService.new(billing_entity:).call if eu_tax_management
