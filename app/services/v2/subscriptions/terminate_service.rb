...
module V2
  module Subscriptions
    # Terminates a subscription in the new engine: ends every still-active product
    ...
    class TerminateService < BaseService
      ...
      def call
        ActiveRecord::Base.transaction do
          result.subscription_rate_cards = subscription.applied_rate_cards.where(ended_at: nil).map do |item|
