      ...
      def build_filter_data(grouped_fees)
...

        {
          **usage_data.except(:amount_currency),
          ...
          presentation_breakdowns: PresentationBreakdownBuilder.call(grouped_fees, filter: PresentationBreakdownBuilder::ALL, filter_breakdown: PresentationBreakdownBuilder::ALL)
        }
      end
